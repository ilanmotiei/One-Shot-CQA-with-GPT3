# One Shot Conversational Question Answering with GPT3

Code for our NLP course research paper: [Generating Good In-Context Samples for Conversational Question Answering](https://github.com/ilanmotiei/One-Shot-CQA-with-GPT3/blob/main/paper.pdf).
